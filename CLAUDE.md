...
| `menu_categories` | `id, code, name, name_en, parent_code, enabled, sort_order` | the categories themselves, two levels (`parent_code` null = top level). POS 菜单管理 → 分类管理 |
